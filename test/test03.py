...
# ================== 配置类 ==================
class Config:
    EMBED_MODEL_PATH = r"D:\04_Learn\AI\models\sungw111\text2vec-base-chinese-sentence"
    RERANK_MODEL_PATH = r"D:\04_Learn\AI\models\BAAI\bge-reranker-large"
...
def init_models():
    ...
    # )
    llm = OpenAILike(
        model="qwen-max",  # 可选模型：qwen, qwen-plus, qwen-max
        api_base=Config.LLM_MODEL_PATH,  # 关键！必须指定此端点
        api_key=Config.LLM_API_KEY,
        context_window=128000,    # 按需调整
        is_chat_model=True,
